        ...
        <section class="hidden lg:block">
          <div class="max-w-lg">
            ...
            <p class="mt-4 text-base text-slate-600">
              Pick a strong password you have not used elsewhere. You will be able to sign in immediately after saving.
            </p>
          </div>
        </section>
                ...
                <form @submit.prevent="submit" class="mt-6 space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      :class="[
                        ...
                        errors.email ? 'ring-red-300' : 'ring-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-400/40'
                      ]"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <div class="relative mt-2">
                      <input
                        ...
                        :class="[
                          'w-full rounded-2xl bg-white px-4 py-3 pr-12 text-[15px] text-slate-900 ring-1',
                          errors.password ? 'ring-red-300' : 'ring-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-400/40'
                        ]"
                      />
                      <button
                        type="button"
                  ...
                  <button
                    ...
                    class="w-full rounded-2xl bg-emerald-600 px-4 py-3 text-[15px] font-semibold text-white shadow-lg shadow-emerald-600/20
                           hover:bg-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-400/40
                  ...
                  <p class="text-center text-sm text-slate-500">
                    <Link href="/forgot-password" class="font-semibold text-emerald-700 hover:text-emerald-800">
                      Request a new link
                    </Link>
                    &nbsp;·&nbsp;
